...
import { Columns, Download, Printer } from "lucide-react";
    ...
    <div className="mb-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="inline-flex items-center justify-center text-sm text-white bg-blue-600 rounded px-2 h-6">189</span>
        </div>
