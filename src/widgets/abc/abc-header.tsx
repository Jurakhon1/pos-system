...
export function AbcHeader({ className }: AbcHeaderProps) {
  return (
    <div className={cn("mb-6 flex items-center justify-between", className)}>
      <div className="flex items-center">
        <h2 className="mr-2 text-2xl font-semibold text-gray-800">ABC-анализ</h2>
        <span className="text-lg text-gray-500">294</span>
      </div>
