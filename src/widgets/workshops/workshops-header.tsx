    ...
    <div className="mb-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h2 className="text-2xl font-bold text-gray-900">Цехи</h2>
          <span className="inline-flex items-center justify-center text-sm text-white bg-blue-600 rounded px-2 h-6">2</span>
        </div>
